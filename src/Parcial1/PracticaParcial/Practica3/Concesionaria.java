...
public class Concesionaria implements Serializable{
    ...
    public void guardar(ArrayList<Vehiculo> listaVehiculos){
        try {
            FileOutputStream fileOut = new FileOutputStream("src\\Parcial1.PracticaParcial\\Practica3\\ListaVehiculos");
    ...
    public ArrayList<Vehiculo> cargar(){
        ...
        try{
            FileInputStream fileIn = new FileInputStream("src\\Parcial1.PracticaParcial\\Practica3\\ListaVehiculos");
